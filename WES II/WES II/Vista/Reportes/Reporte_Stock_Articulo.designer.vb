...
Partial Class Reporte_Stock_Articulo
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Reporte_Stock_Articulo))
        ...
        Me.SP_Stock_ArticuloBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.SP_Stock_Articulo_x_ContenedorTableAdapter = New WES_II.DS_Wes_II_TestBTableAdapters.SP_Stock_Articulo_x_ContenedorTableAdapter()
        Me.SP_Stock_Articulo_x_ContenedorBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.Panel1.SuspendLayout()
        Me.Panel2.SuspendLayout()
        Me.TableLayoutPanel1.SuspendLayout()
        CType(Me.DS_Wes_II_TestB, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.SP_Stock_ArticuloBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.SP_Stock_Articulo_x_ContenedorBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'Panel1
        '
        ...
        Me.Label1.Text = "Reporte Stock Articulo"
        '
        'Label2
        '
        ...
        ReportDataSource1.Name = "DataSet_Stock_x_Contenedor"
        ReportDataSource1.Value = Me.SP_Stock_Articulo_x_ContenedorBindingSource
        Me.reportViewer.LocalReport.DataSources.Add(ReportDataSource1)
        Me.reportViewer.LocalReport.ReportEmbeddedResource = "WES_II.Informe_Stock_Articulo.rdlc"
        ...
        '
        'SP_Stock_ArticuloBindingSource
        '
        Me.SP_Stock_ArticuloBindingSource.DataMember = "SP_Stock_Articulo_x_Contenedor"
        Me.SP_Stock_ArticuloBindingSource.DataSource = Me.DS_Wes_II_TestB
        '
        'SP_Stock_Articulo_x_ContenedorTableAdapter
        '
        Me.SP_Stock_Articulo_x_ContenedorTableAdapter.ClearBeforeFill = True
        '
        'SP_Stock_Articulo_x_ContenedorBindingSource
        '
        Me.SP_Stock_Articulo_x_ContenedorBindingSource.DataMember = "SP_Stock_Articulo_x_Contenedor"
        Me.SP_Stock_Articulo_x_ContenedorBindingSource.DataSource = Me.DS_Wes_II_TestB
        '
        'Reporte_Stock_Articulo
        '
        ...
        Me.Name = "Reporte_Stock_Articulo"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "GDA - Reportes - Reporte Stock Articulo"
        ...
        CType(Me.SP_Stock_ArticuloBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.SP_Stock_Articulo_x_ContenedorBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents SP_Stock_ArticuloBindingSource As BindingSource
    Friend WithEvents SP_Stock_Articulo_x_ContenedorTableAdapter As DS_Wes_II_TestBTableAdapters.SP_Stock_Articulo_x_ContenedorTableAdapter
    Friend WithEvents SP_Stock_Articulo_x_ContenedorBindingSource As BindingSource
End Class
